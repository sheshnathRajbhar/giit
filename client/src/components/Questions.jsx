...
<button ref={option1} onClick={(e)=>checkAnswer(e)} value="1" className='w-full border-gray-300 border-1 border py-1 px-3 rounded text-left my-2'>{question.option1}</button>
<button ref={option2} onClick={(e)=>checkAnswer(e)} value="2" className='w-full border-gray-300 border-1 border py-1 px-3 rounded text-left my-2'>{question.option2}</button>
<button ref={option3} onClick={(e)=>checkAnswer(e)} value="3" className='w-full border-gray-300 border-1 border py-1 px-3 rounded text-left my-2'>{question.option3}</button>
<button ref={option4} onClick={(e)=>checkAnswer(e)} value="4" className='w-full border-gray-300 border-1 border py-1 px-3 rounded text-left my-2'>{question.option4}</button>
<div className="action-btn w-full flex justify-between">
  <button className='sm:w-[150px] w-[70px] py-1 sm:py-2 text-center bg-blue-600 rounded text-white'>PREV</button>
